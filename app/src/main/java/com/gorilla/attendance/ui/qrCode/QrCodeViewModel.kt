...
class QrCodeViewModel @Inject constructor(
    ...
    private val mQrCodeRepository: QrCodeRepository = qrCodeRepository
    ...
    fun verify(securityCode: String?, clockModule: Int) {
        ...
        val disposableObserver = object : DisposableSingleObserver<List<Acceptances>>() {
            ...
            override fun onError(e: Throwable) {
                Timber.d("verify QR code onError e = $e")
        ...
        if (clockModule != SharedViewModel.MODULE_VISITOR) {
            ...
            mCompositeDisposable.add(
                mQrCodeRepository.verifyEmployee(securityCode)
            ...
            mCompositeDisposable.add(
                mQrCodeRepository.verifyVisitor(securityCode)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeWith(disposableObserver)
            )
    ...
    private fun deleteVisitorFromDB(visitor: Acceptances) {
        ...
        mCompositeDisposable.add(
            mQrCodeRepository.deleteVisitor(visitor)
                .observeOn(AndroidSchedulers.mainThread())
