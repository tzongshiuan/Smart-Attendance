...
class RFIDFragmentTest {
    ...
    /**
     * rfidVerificationTest
     */
    @Test
    fun rfidVerificationTest() {
        Timber.d("[UnitTest][rfidVerificationTest] *** Start ***")
        ...
        MainActivity.testSecurityCode = TestTool.TEST_RFID

        TestTool.enterSpecifiedMode(fetchIdling, TestTool.MEMBER_EMPLOYEE, TestTool.MODE_RFID)
        Timber.d("[UnitTest] navigate to RFIDFragment success")

        // test valid security code
        Timber.d("[UnitTest] test scan RFID success")
        ...
        Timber.d("[UnitTest][rfidVerificationTest] *** End ***")
        blockUI(3000)
    }

    /**
     * rfidRegistrationTest
     */
    @Test
    fun rfidRegistrationTest() {
        Timber.d("[UnitTest][rfidRegistrationTest] *** Start ***")
        ...
        MainActivity.testSecurityCode = "${TestTool.TEST_RFID}_$random"
        ...
        Timber.d("[UnitTest][rfidRegistrationTest] *** End ***")
        blockUI(3000)
    }
