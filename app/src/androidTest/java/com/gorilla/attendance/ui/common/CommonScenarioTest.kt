...
class CommonScenarioTest {
     ...
     */
    @Test
    fun commonScenarioTest() {
        Timber.d("[UnitTest][commonScenarioTest] *** Start ***")
        ...
        Timber.d("[UnitTest] register success, user id: ${TestTool.TEST_EMPLOYEE_ID}_$random")
        blockUI(2000)
        ...
        TestTool.enterSettingFragment(fetchIdling, 1, false)
        onView(withId(R.id.appModeSpinner)).perform(scrollTo())
        blockUI(500)
        ...
        onView(withId(R.id.securityCodeEditText)).perform(TestTool.setTextInEditText("${TestTool.TEST_SECURITY_CODE}_$random"))
        blockUI(500)
        onView(withId(R.id.btnRight)).perform(click())
        ...
        Timber.d("[UnitTest][commonScenarioTest] *** End ***")
        blockUI(3000)
    }
