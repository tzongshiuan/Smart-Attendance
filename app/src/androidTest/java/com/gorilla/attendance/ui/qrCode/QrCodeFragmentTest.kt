...
class QrCodeFragmentTest {
    ...
    fun setUp() {
        ...
        MainActivity.IS_SKIP_SCAN_CODE = true
    }

    /**
     * qrCodeVerificationTest
     */
    @Test
    fun qrCodeVerificationTest() {
        Timber.d("[UnitTest][qrCodeVerificationTest] *** Start ***")
        ...
        MainActivity.testSecurityCode = "Invalid QrCode"

        TestTool.enterSpecifiedMode(fetchIdling, TestTool.MEMBER_EMPLOYEE, TestTool.MODE_QR_CODE)
        Timber.d("[UnitTest] navigate to QrCodeFragment success")
        ...
        MainActivity.testSecurityCode = TestTool.TEST_SECURITY_CODE
        onView(withId(R.id.btnRight)).perform(click())
        ...
        Timber.d("[UnitTest][qrCodeVerificationTest] *** End ***")
        blockUI(3000)
    }

    /**
     * qrCodeRegistrationTest
     */
    @Test
    fun qrCodeRegistrationTest() {
        Timber.d("[UnitTest][qrCodeRegistrationTest] *** Start ***")
        ...
        MainActivity.testSecurityCode = "${TestTool.TEST_SECURITY_CODE}_$random"
...
//        onView(withId(R.id.employeeRegisterForm)).perform(TestTool.setChildEditTextWithId(R.id.employeeSecurityEditText, "07121234_$random"))
//        blockUI(500)
        ...
        Timber.d("[UnitTest][qrCodeRegistrationTest] *** End ***")
        blockUI(3000)
    }
